  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="escritorio.php" class="logo">
        ...
        <span class="logo-mini"><b>Neo</b>Tec</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>NeoTec</b></span>
      </a>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    ...
                    <small>www.youtube.com/jorgeantonymilianmontalvo</small>
                  </p>
                </li>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <a href="acerca.php">
            ...
            <small class="label pull-right bg-yellow">NT</small>
          </a>
        </li>
