            ...
            <div class="box">
              <div class="box-header with-border">
                ...
                <h1 class="box-title">Ingreso
                  <!-- Botón Agregar -->
                  <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true); generarCodigos();">
                    <i class="fa fa-plus-circle"></i> Agregar
                  </button>

                  <!-- Botón Reporte existente -->
                  <a target="_blank" href="../reportes/rptingresos.php">
                    <button class="btn btn-info"><i class="fa fa-clipboard"></i> Reporte</button>
                  </a>
                </h1>

                <script>
                  // Función para generar un número aleatorio con una longitud específica
                  function generarNumeroAleatorio(longitud) {
                    const min = Math.pow(10, longitud - 1); // Mínimo número de "longitud" dígitos
                    const max = Math.pow(10, longitud) - 1; // Máximo número de "longitud" dígitos
                    return Math.floor(Math.random() * (max - min + 1)) + min;
                  }

                  // Función para asignar los números aleatorios a Serie y Número
                  function generarCodigos() {
                    document.getElementById('serie_comprobante').value = generarNumeroAleatorio(7); // 7 dígitos
                    document.getElementById('num_comprobante').value = generarNumeroAleatorio(10); // 10 dígitos
                  }
                </script>
